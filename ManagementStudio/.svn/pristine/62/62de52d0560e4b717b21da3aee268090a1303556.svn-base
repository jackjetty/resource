...
<body style="background: #DFE8F6;">
		...
		<table height="100%">
			<tr	style="Valign: center; text-decoration: none; line-heigth: 30px; height: 30px; margin-left: 50px;">
				...
				<td><select id="toTime" style="width: 95px;" ><option value="0">请选择</option><option value="1">按天</option><option value="2">按周</option>				
				<option value="3">按月</option></select></td>
...
<script type="text/javascript">
	...
	function tubiao(placeName,typeLeiXing,toTime,startTime,endTime){
		var titleText=startTime+'至'+endTime+''+placeName+'签到用户数统计信息';
		$.ajax({
			url : "getUserCheckinByImage.action",
			async : false,
			type : "post",
