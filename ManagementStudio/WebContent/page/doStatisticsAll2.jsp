...
<body style="background: #DFE8F6;">
	<div id="searchpanel" class="easyui-panel panel-margin-buttom"
		...
		<form action="getStatisticsAll3.action" method="post" id="form1" style="height:100%;">
		<table height="100%">
		...
		$(function() {
			$.ajax({
				...
				success : function(data) {
					...
					if(busId=='1031'){
						option = $("<option value='1031' selected='true'>Q币包月2</option>");
						$("#busId").append(option);
					}else{
						option = $("<option value='1031'>Q币包月2</option>");
						$("#busId").append(option);
					}
				},
				error : function(data) {
