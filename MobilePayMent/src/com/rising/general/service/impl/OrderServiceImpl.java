...
public class OrderServiceImpl implements OrderService {
	...
	public String pay(HashMap<String, String> map){
		...
		*/
		...
		HashMap<String, Object> payRstMap=null;
		boolean sign=false;
		try {
			 payRstMap =  payOrder.payOrder(payParaMap, business.getPayOrderURL());
		} catch (Exception e1) {
			// TODO Auto-generated catch block
			e1.printStackTrace();
		}
		if ("0".equals(payRstMap.get("result"))){
			sign=true;
		}
...
*/
		...
		try {
			resultMap=payOrder.payOrder(paraMap, b.getPayOrderURL()   );
