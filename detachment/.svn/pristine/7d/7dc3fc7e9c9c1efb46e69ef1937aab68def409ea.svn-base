...
public class AccidentStoreBean implements Serializable{
	...
	private ArrayList <VoiceStoreInfo> voiceInfoList;
	...
	public String getTxtDirPath() {
		return txtDirPath;
	}
	public void setTxtDirPath(String txtDirPath) {
		this.txtDirPath = txtDirPath;
	}
	...
	public ArrayList<VoiceStoreInfo> getVoiceInfoList() {
		return voiceInfoList;
	}
	public void setVoiceInfoList(ArrayList<VoiceStoreInfo> voiceInfoList) {
