...
$.fn.study_vote= function(options,totle){
	...
	container.html('<dl id="studyvote" class="q"></dl>');
	...
	var study_votestr="";
		for(i=0;i<settings.length;i++)
		{
			...
			study_votestr +='<dd class="dd"><div class="fl"><span>'+settings[i].name+'：</span></div><div class="outbar"><div class="inbar" style="width:'+studyplay_present+'%;background:'+settings[i].color+';"></div></div> <div class="fl1"><b>'+settings[i].data+'</b> </div></dd>';
		}
