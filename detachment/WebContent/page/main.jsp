...
.cs-north-right ul li.home {
	background: url(image/main/home.gif) no-repeat 0 0;
}

.cs-north-right ul li.password {
	background: url(image/main/password.gif) no-repeat 0 0;
	margin-left: 15px;
}

.cs-north-right ul li.refresh {
	background: url(image/main/refresh.gif) no-repeat 0 0;
	margin-left: 15px;
}

.cs-north-right ul li.exit {
	background: url(image/main/exit.gif) no-repeat 0 0;
	margin-left: 15px;
}
...
<body class="easyui-layout" id="tt" onload="startClock()">
	<div region="north" border="false" class="cs-north">
		...
		<div class="newtime">现在时间：<font id="newTime"></font></div>
	...
	<div region="south" border="false" id="south"
		style="background: #DFE8F6;">
		<center>Copyright © 江干教育技术中心</center>
	</div>
</body>
</html>