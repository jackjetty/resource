...
public class BaseDaoImpl<T> implements BaseDao<T>{
    ...
    public List<T> findBySQL(String sql, Object... params) {  
    	...
    	try { 
			...
			log.debug("findBySQL  params successful");
		} catch (RuntimeException re) {
			log.error("findBySQL  params  failed", re);
			throw re;
		}   
    ...
    public List<T> findBySQL(String sql,ArrayList arraylist) {  
    	...
    	try { 
			...
			log.debug("findBySQL  arraylist successful");
		} catch (RuntimeException re) {
			log.error("findBySQL  arraylist  failed", re);
			throw re;
		}   
