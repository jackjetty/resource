...
@Controller("carMoveAction")
public class CarMoveAction implements ServletRequestAware, ServletResponseAware, ServletContextAware,ApplicationAware{
	...
	public String getCarMove() {
		result = carMoveService.getCarMove(startTime, endTime, reportPhoneNumber,
				carNumber, carMoveState, pageSize, pageIndex);
		return "success";
	}
	public String getCarMovePic(){
		tap = carMoveService.getCarMovePic(carMoveId);
		return "success";
		
	}
	public String getMoveCarAddress(){
		result = carMoveService.getMoveCarAddress(carMoveId);
		return "success";
	}
	public String updateCarMoveState(){
		result = carMoveService.exchangeStatus(carMoveId,managerName);
		return "success";
	}
	
	public String saveFailInfo(){
		result = carMoveService.saveFailInfo(carMoveId,managerName,remark);
		return "success";
	}
	
	public String getMoveCarByCarMoveId(){
		moveCarVo=carMoveService.getCarMoveByCarMoveId(carMoveId);
		return "success";
	}
	public String saveProcedureMessageMove(){
		result =carMoveService.saveprocedureMessage1(managerName, carMoveId);
	...
	public String responseWeiMoveCar(){
		result = carMoveService.responseWei(carMoveId);
