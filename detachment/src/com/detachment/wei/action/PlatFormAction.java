...
public class PlatFormAction  implements ServletRequestAware, ServletResponseAware, ServletContextAware,ApplicationAware{
	...
	private BaseBean processMessage(SessionModel session,BaseBean inMsg,String msgType){
		...
		if(session.getAttribute("lastOperationStage")!=null
				&&session.getAttribute("lastOperationStage") instanceof  CarMoveProcess ){
		...
		if(session.getAttribute("lastOperationStage")!=null
				&&session.getAttribute("lastOperationStage") instanceof  FormalAccidentProcess ){
		...
		if(session.getAttribute("lastOperationStage")!=null
				&&session.getAttribute("lastOperationStage") instanceof  TestAccidentProcess ){
		...
		if(session.getAttribute("lastOperationStage")!=null
				&&session.getAttribute("lastOperationStage") instanceof  FeedBackProcess ){
		...
		if(session.getAttribute("lastOperationStage")!=null
				&&session.getAttribute("lastOperationStage") instanceof  HandyPhotoProcess ){
