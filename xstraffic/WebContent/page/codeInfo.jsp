...
<title>详情</title>
    ...
    $(function() {
		...
		for ( var i = 0; i < values.length; i++) {
			...
			if (pos == -1)
				continue;
			codeId = values[i].substring(pos + 1);
		}
		$.ajax({
			url : "getCodeInfo.action",
			type : "post",
			async : false,
			data : "codeId=" + codeId,
			dataType : "json",
			success : function(data) {
				$('#activity-name').html(data.title);
				$('#post-date').html(data.time);
        ...
        <!--[if lt IE 9]>
    <link rel="stylesheet" type="text/css" href="pc-page1d0858.css"/>
    <![endif]-->
    <link media="screen and (min-width:1000px)" rel="stylesheet" type="text/css" href="../css/pc-page1d0858.css"/>
    <style>
...
<body id="activity-detail">
        ...
        <div class="page-bizinfo">
            ...
            <p class="activity-info">
                <span id="post-date" class="activity-meta no-extra"></span>
                <span class="activity-meta no-extra" style="color:#607fa6;"></span>
