...
<div id="imgLoading" align="center"  style="margin-top:50%;display:none;"><img  src="image/5-130H2191323.gif" /><br />正在加载,请稍后!</div>
  ...
  <div data-role="navbar" class="ui-body-d ui-content" style="">
    <ul>
      ...
      <li  class="" id="peopleWfLi"><a href="#two" data-ajax="false" class="" id="peopleWf" style="border-right: 1px solid #CCCCCC;">驾驶员记分查询</a></li>
    </ul>
  </div>
  <div id="one" class="ui-body-d ui-content" style="margin-top:-10px;">
    
   <div id="beizhu" style="display:block;"><span style="color:red;">注：</span>请认真填写完整的车辆信息,详细信息请查看您的行驶证</div>
   <div id="result1"></div>
   <div></div>
   <br/>
    	<div >
 	...
 	<div> <span style="width:70px;">车牌号码:</span>
    	...
    	<input name="carid" type="text" id="carid" size="8" placeholder="如:B01011"  style="width:100%;" />
     	<span id="errorCarid" style="color:red;display:none;">请输入正确车牌号!如B01001</span>
     </div>
  	<div><span style="width:100px;">车架号/车辆识别号(后六位):</span>
    	<input name="carno" type="text" id="carno" size="10" style="width:100%;" value="" placeholder="在机动车行驶证中查看"/>
