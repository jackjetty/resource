...
import com.traffic.wei.store.CongestStoreBean;
import com.traffic.wei.store.HandyPhotoStoreBean;
...
public class  ProcessServiceImpl implements ProcessService{
	...
	@Value("${traffic.contact}") 
	protected String  TRAFFIC_CONTACT; 
	@Value("${traffic.name}") 
	protected String  TRAFFIC_NAME;
	 
	
	@Value("${wei.root.dir}") 
	protected String  dir_root; 
	...
	protected void saveUserInfo(String phoneNumber){
		TbWeiUser tbWeiUser=weiUserDao.findById(openId);
		if(tbWeiUser!=null){
			tbWeiUser.setPhoneNumber(phoneNumber) ;
